...
public class GameFrame extends JFrame implements ActionListener ,MouseListener,KeyListener{
    ...
    public static void main(String[] args) throws InterruptedException{
        ...
        Sound player = new Sound("/Users/wanle/source/workspace/ideaProjects/project/Sokoban/src/resource/nor.mid");   //创建音乐播放器
    ...
    public void getPic(){
        ...
        for(int i=0;i<=13;i++){
            pic[i] = Toolkit.getDefaultToolkit().getImage
                    ("/Users/wanle/source/workspace/ideaProjects/project/Sokoban/src/resource/pic"+i+".png");
